...
pub trait MatrixTrait {
    ...
    fn generate(m: usize, n: usize, f: &dyn Fn(usize, usize) -> f64) -> Self;
    fn generate_by_row(m: usize, n: usize, f: &dyn Fn(usize) -> Vec<f64>) -> Self;
    ...
    fn map(&self, f: &dyn Fn(f64, usize, usize) -> f64) -> Matrix;
    fn map_row(&self, f: &dyn Fn(Vec<f64>) -> Vec<f64>) -> Matrix;
...
impl MatrixTrait for Matrix {
    ...
    /// # }
    /// ```
    fn generate(m: usize, n: usize, f: &dyn Fn(usize, usize) -> f64) -> Matrix {
    ...
    fn generate_by_row(m: usize, n: usize, f: &dyn Fn(usize) -> Vec<f64>) -> Matrix {
        let mut mtx: Vec<Vec<f64>> = Vec::with_capacity(m);
    ...
    fn random(m: usize, n: usize) -> Matrix {
        ...
        let result=Matrix::generate(m, n, &|_, _| {
